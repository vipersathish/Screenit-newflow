...
public class ScreenItNewFlow {
	...
	public static void main(String[] args) throws AWTException, InterruptedException {
		...
		WebElement interviwerlists = driver.findElement(By.xpath("(//button[text()='Select'])[2]"));
		...
		try {
			...
			WebElement highstatus4 = driver.findElement(By.xpath("//div[@class='status col-mod-3']"));
			JavascriptExecutor jsExecutor4 = (JavascriptExecutor) driver;
			jsExecutor4.executeScript("arguments[0].style.border='2px solid red'", highstatus4);

			WebElement status4 = driver.findElement(By.xpath("//div[@class='status col-mod-3']"));
		...
		driver.findElement(By.xpath("//span[@class='direct-chat-timestamp'][2]")).click();

		driver.findElement(By.xpath("//button[text()='Yes']")).click();

		WebElement status6 = driver.findElement(By.xpath("//span[@class='direct-chat-timestamp'][2]"));

		String data6 = status6.getText();

		System.out.println("Status--" + data6);

		driver.findElement(By.xpath("//div[@class='statusName']//a")).click();

		driver.findElement(By.xpath("//button[text()='View FeedBack']")).click();
