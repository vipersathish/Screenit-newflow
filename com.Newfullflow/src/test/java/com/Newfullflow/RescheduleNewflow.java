...
public class RescheduleNewflow {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		WebElement interviwerlists = driver.findElement(By.xpath("(//button[text()='Select'])[3]"));
		...
		driver.findElement(By.xpath("(//a[text()=' Re-Schedule '])[1]")).click();

		WebElement reson = driver.findElement(By.xpath("//select[@id='reason']"));

		Select options = new Select(reson);

		options.selectByVisibleText("Candidate is not available");

		WebElement com = driver.findElement(By.xpath("//textarea[@placeholder='Enter Comments*']"));

		com.sendKeys("postion is closed");
